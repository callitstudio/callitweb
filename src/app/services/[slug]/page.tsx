...
import { getRelatedSubservices } from '@/data/subservices';
...
export default function ServicePage({ params }: ServicePageProps) {
  ...
  const benefits =
    serviceBenefits[params.slug as keyof typeof serviceBenefits] || [];

  // Get related subservices for this service from the subservices data
  const relatedSubservices = getRelatedSubservices(params.slug);
              ...
              >
                ...
                <div className="flex flex-col flex-grow p-6">
                  <CardHeader className="p-0 pb-4">
                    <SubserviceIcon className="h-8 w-8 text-primary mb-3" />
